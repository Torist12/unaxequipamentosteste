        ...
        <Card className="rounded-3xl shadow-2xl border-0 bg-card/95 backdrop-blur">
          ...
          <CardContent className="pb-10">
            <form onSubmit={handleSubmit} className="space-y-5">
              {error && (
                <div className="flex items-center gap-2 p-3 rounded-xl bg-destructive/10 text-destructive text-sm animate-slide-up">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="••••••••"
                  className={`rounded-xl h-12 ${fieldErrors.password ? 'border-destructive' : ''}`}
                  maxLength={100}
              ...
              <Button 
                type="submit" 
                className="w-full h-12 rounded-xl text-base font-semibold gap-2 bg-primary hover:bg-primary/90 shadow-lg shadow-primary/25"
                disabled={isSubmitting}
              >
                {isSubmitting ? (
                  <>
